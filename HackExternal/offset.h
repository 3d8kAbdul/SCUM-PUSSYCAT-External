...
inline namespace BloodHunt
{
	...
	{
	public:
		const char* dwProcessName = "SCUM.exe";
...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_u_world = 0x731c610; // IDA searching for Names: UWorldProxy GWorld
		DWORD offset_g_names = 0x7199e40;
		...
		DWORD offset_player_name = 0x300; //APlayerState	PlayerNamePrivate 0x300
